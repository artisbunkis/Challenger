...
<div class="container">
    <div class="d-flex justify-content-between" id="myBtnContainer">
        <div >
            <button type="button" class="btn btn-secondary btn-sm butn" style="font-size: 14px;" onclick="filterSelection(1000)" value="1000">All</button></p>   
        </div>
        @isset($sportsTypes)
            @foreach($sportsTypes as $sportsType)
            <div >
                <button type="button" class="btn btn-secondary btn-sm butn" style="font-size: 14px;" onclick="filterSelection($sportsType->sportsTypeID)" value="{{$sportsType->sportsType_ID}}">{{$sportsType->sportsTypeName}}</button></p>   
            </div>
